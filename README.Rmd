...
In this moment I'm adding a non-homogeneous Poisson processes inspired from  [Kodikara 2020](https://besjournals.onlinelibrary.wiley.com/doi/abs/10.1111/2041-210X.13542) 
...
This is a basic example which shows you how to estimate the posterior distribution of the extant probability of an extinct species in different sites:
